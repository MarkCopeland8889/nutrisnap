...
export default function HomePage() {
  const handleInstallPWA = () => {
    if (window.deferredPrompt) {
      ...
      alert(
        'To install this app, please use your browser\'s menu and look for "Add to Home Screen" or "Install App" option.'
      );
    }
  };
  ...
  return (
    <>
      ...
      <main className="font-inter text-slate-800 bg-white">
        {/* Hero Section */}
        <section className="bg-green-600 text-white py-20 md:py-32">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            <p className="text-lg md:text-xl mb-4">
              ...
              <strong className="underline">100% FREE to use and get started!</strong>
            </p>
            <p className="text-md md:text-lg mb-8 text-green-200 font-semibold">
              Our AI scanner boasts a 93.5% accuracy rate in food analysis, giving you reliable insights.
            </p>
        ...
        <section className="py-16 md:py-24 bg-slate-50">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
                <div className="text-5xl mb-4 text-green-500">🤖</div>
                <h3 className="text-xl font-semibold mb-2">2. AI Analyzes with 93.5% Accuracy</h3>
                <p className="text-slate-600">
                  Our advanced AI instantly breaks down the nutritional content with high precision.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
                <div className="text-5xl mb-4 text-green-500">📊</div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">
                      Identify common unwanted ingredients like seed oils and artificial preservatives to make healthier choices.
                    </p>
                  </div>
                </div>
                <div className="flex items-start p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">
                      Access all core features without any subscription fees. Seriously. Our mission is accessible health.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
                    ...
                    >
                      <svg
                        ...
                        strokeWidth="2"
                      >
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2zM12 3v10m0 0L9 9m3 4l3-4" />
                      </svg>
                      Install Web App (PWA)
                    </button>
                    <a
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M5.293 2.293a1 1 0 011.414 0l2 2a1 1 0 010 1.414l-2 2a1 1 0 01-1.414-1.414L6.586 5 5.293 3.707a1 1 0 010-1.414zM14.707 17.707a1 1 0 01-1.414 0l-2-2a1 1 0 010-1.414l2-2a1 1 0 111.414 1.414L13.414 15l1.293 1.293a1 1 0 010 1.414zM10 2a1 1 0 011 1v14a1 1 0 11-2 0V3a1 1 0 011-1z"
                          clipRule="evenodd"
                        />
                      </svg>
                      Download Android App (APK)
